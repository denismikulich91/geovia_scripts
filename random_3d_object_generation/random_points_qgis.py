...
processing.run("qgis:randompointsinsidepolygons", {'INPUT':input_file, 'STRATEGY':0,'VALUE':350, 'MIN_DISTANCE':1,'OUTPUT':output_file})
...
QgsVectorFileWriter.writeAsVectorFormat(layer, r"E:\MDA\Beta Testing\City\Sunderland data sets\scripting\qgis_coords.csv", "utf-8",driverName = "CSV")



# Read CSV and populate GeoJSON file

with open(r"E:\MDA\Beta Testing\City\Sunderland data sets\scripting\qgis_coords.csv", 'r') as coords:
